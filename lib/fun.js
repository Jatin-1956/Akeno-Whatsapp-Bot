...
const truth = () => new Promise((resolve, reject) => {
    ...
    fetchText('https://raw.githubusercontent.com/Jazzboy-12/BocchiBot/master/message/truth.txt')
...
const truthkinky = () => new Promise((resolve, reject) => {
    ...
    fetchText('https://raw.githubusercontent.com/Jazzboy-12/BocchiBot/master/message/truthkinky.txt')
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const pickup = () => new Promise((resolve, reject) => {
    ...
    fetchText('https://raw.githubusercontent.com/Jazzboy-12/BocchiBot/master/message/pickup')
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const flirty = () => new Promise((resolve, reject) => {
    ...
    fetchText('https://raw.githubusercontent.com/Jazzboy-12/BocchiBot/master/message/flirtytext.txt')
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const dare = () => new Promise((resolve, reject) => {
    ...
    fetchText('https://raw.githubusercontent.com/Jazzboy-12/BocchiBot/master/message/dare.txt')
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
