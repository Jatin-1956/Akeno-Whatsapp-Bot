...
export function help(prefix, pushname) {
...
🌟️ *Adding bot to a group* 🌟️ _Contact the bot owner[+96895268451] to add the bot to a group_
...
Usage: *${prefix}sticker* as caption of a picture/gif or reply to a picture/gif and *${prefix}sticker nocrop* as caption of a picture/gif or reply to a picture/gif to give non-cropped stickers. **IF IT RETURNS AN EMPTY STICKER, JUST FORWARD THE GIF/IMAGE AND TRY AGAIN (DON'T SEND SAME GIF FROM tenor AGAIN)**

*_CMD: ${prefix}stickermeme_* / *_${prefix}stcmeme_*
*Description: Create a sticker meme USING ONLY TEXT* 🔖️
Usage: *(Don't use emojis/special characters/numbers and include '|' always)* Send images with caption *${prefix}stickermeme* upper_text | bottom_text or reply to the images with a caption *${prefix}stickermeme* upper_text | bottom_text 
...
*_CMD: ${prefix}kissu_* [Don't know why my owner-sama decide to add this]
...
*_CMD: ${prefix}lyrics <song-name>_* [UNSTABLE - might work]
*Description: Sends lyrics of song* 🗣️
Usage: ${prefix}lyrics never gonna give you up
